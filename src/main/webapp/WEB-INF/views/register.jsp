...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();"
	...
	<div id="main">
		...
		<fieldset>
			...
			<legend style="font-size:20px;"><b>Registration</b></legend>
			<div style="position: relative; left: 320px;display:inline-block;width:150px;">
				<form action="index" method="post" commandName="register">
                    <span><b>Name:</b></span>&nbsp;<input type="text" id="name"
                        name="name" maxlength="45" required /> <br />
                    <span><b>Date of Birth:</b></span>&nbsp;<input type="date" id="dob"
					...
					<span><b>Username:</b></span>&nbsp;<input type="text" id="user_name"
						name="userName" maxlength="45" required /> <br /> <span><b>Password:</b></span> <input
						type="password" id="password_reg" name="password" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" title="Atleast one UpperCase, LowerCase, Number/SpecialChar and min 8 Chars"  required /> <br />
					<span><b>Email:</b></span><br/>
					<input
                        type="email" id="e_mail" name="email" maxlength="45" required /> <br />
					<span><b>Address:</b></span>&nbsp;<textarea cols="17" rows="3" id="address"
                        name="address" maxlength="100"  required ></textarea> <br />
					...
					<span><b>City:</b></span>&nbsp;<input type="text" id="city"
                        name="city" maxlength="60" required /> <br />   
                        
					<span><b>Mobile Number:</b></span>&nbsp;
					<input type="text" id="mobile" title="Minimum 12 digits and maximum 15."
                        name="mobile" pattern=".[0-9]{12,15}"
 style="width:163px;" required/> <br />
					
					 <br /> <input type="submit" class="button" name="signup"
						id="submit_signup" value="Register" /> <br />
